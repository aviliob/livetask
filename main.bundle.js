...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__groups_groups_component__ = __webpack_require__("./src/app/groups/groups.component.ts");
...
var routes = [
    ...
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__main_main_component__["a" /* MainComponent */],
        children: [
            ...
            { path: 'groups', component: __WEBPACK_IMPORTED_MODULE_11__groups_groups_component__["a" /* GroupsComponent */] }
        ]
    }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__groups_groups_component__ = __webpack_require__("./src/app/groups/groups.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_37__groups_groups_component__["a" /* GroupsComponent */],
            ],
            imports: [
...
module.exports = "<header class=\"main-header d-flex justify-content-center align-items-center\">\n    <h2>Grupos</h2>\n</header>\n<section class=\"main-content d-flex\">\n  <app-task-list [orderBy]=\"orderBy\" [complete]=\"complete\"  [tasks]=\"tasks\" [groups]=\"groups\" (passSelectedTask)=\"showTask($event)\" class=\"tasks h-100 d-flex d-md-flex flex-column w-100\"></app-task-list>\n</section>\n\n"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.registerUser = function (mail, pass, name) {
        ...
        this.authService.registerUser(mail, pass, name)
            .subscribe(function (data) {
            _this.log_data = data;
            if (_this.log_data.user && _this.log_data.user.uid) {
                _this.setCookie();
            }
            else {
...
var TaskListComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], TaskListComponent.prototype, "groups", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", Object)
